...
| `thumbnail-1932x828.png` | 1932×828 | 목록 썸네일. 원스토어에 올린 스크린샷 세 장을 그대로 얹었다 |
| `01-home.png` | 636×1048 | 세로형 1 — 홈 |
| `02-play.png` | 636×1048 | 세로형 2 — 합 10을 묶는 순간 |
| `03-cards.png` | 636×1048 | 세로형 3 — 오잉 카드 수집 |

썸네일은 `store/screenshots/`의 원스토어 제출본(`01-home`, `03-wow`,
`04-picture`)을 자르지 않고 높이만 맞춰 배치한 것이다. 배경도 홈 화면의 하늘을
늘려 흐린 것이라 새로 그린 그림이나 새로 쓴 문구가 없다. 다시 만들려면
`tools/build-toss-thumbnail.py`를 돌린다.
